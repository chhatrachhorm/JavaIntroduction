package kit.keen.chhatra.Algorithms;
...
/**
 * KEEN doesn't own this class.
 * This rsa class has been taken from other people library.
...
public class rsa {
	...
	public static BigInteger genE(BigInteger phi) {
		...
		do {
			...
			// e.min(a) will return the smallest one
